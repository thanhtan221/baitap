                                            ...
                                            <td>
                                                <div class="btn-group dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right">
                                                        <a class="dropdown-item" href="${pageContext.request.contextPath}/users?action=edituser&id=${listuser.id}"><i
                                                                class="mdi mdi-pencil mr-1 text-muted"></i>Edit Contact</a>
                                                        <a class="dropdown-item" href="${pageContext.request.contextPath}/users?action=deleteuser&id=${listuser.id}"><i
